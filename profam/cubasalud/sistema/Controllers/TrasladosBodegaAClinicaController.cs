...
{
    public class TrasladosBodegaAClinicaController : Controller
    {
        ...
        public TrasladosBodegaAClinicaController(IProducto productoRepository, ITraslados trasladosRepository, UserManager<User> userManager,
        ...
        public JsonResult GuardarTraslado([FromBody]TrasladosBaseViewModel model)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                var nuevoTraslado = new TrasladosProductos()
                {
                    ...
                    TipoTrasladoBodega = "BodegaAClinica"
                };
        ...
        public IActionResult AceptarTraslado(int? id)
        {
            ...
            {
                var productoClinica = _productoRepository.GetProductoByTipoBodegaAndNombre(2, item.Producto.NombreProducto);
                
                // agregar
                if(productoClinica == null)
                {   
                ...
                {
                    productoClinica.Stock += item.Cantidad;
                    productoClinica.StockInical +=  item.Cantidad;

                    _productoRepository.Update(productoClinica, false);
        ...
        public IActionResult Lista(string sortOrder, string buscar, string currentFilter, int? pageNumber)
        {
            ...
            var lista = _trasladosRepository.PaginacionTrasladosBodegaAClinica(sortOrder, buscar, pageNumber, 20);
        ...
        public IActionResult EnTransito(string sortOrder, string buscar, string currentFilter, int? pageNumber)
        {
            ...
            var lista = _trasladosRepository.PaginacionEnTransitoBodegaAClinica(sortOrder, buscar, pageNumber, 20);
        ...
        public IActionResult Aceptados(string sortOrder, string buscar, string currentFilter, int? pageNumber)
        {
            ...
            var lista = _trasladosRepository.PaginacionAceptadosBodegaAClinica(sortOrder, buscar, pageNumber, 20);
        ...
        public IActionResult Faltantes(string sortOrder, string buscar, string currentFilter, int? pageNumber)
        {
            ...
            var lista = _trasladosRepository.PaginacionFaltantesBodegaAClinica(sortOrder, buscar, pageNumber, 20);
        ...
        public IActionResult Cancelados(string sortOrder, string buscar, string currentFilter, int? pageNumber)
        {
            ...
            var lista = _trasladosRepository.PaginacionCanceladosBodegaAClinica(sortOrder, buscar, pageNumber, 20);
        ...
        public IActionResult ConProblema(string sortOrder, string buscar, string currentFilter, int? pageNumber)
        {
            ...
            var lista = _trasladosRepository.PaginacionConProblemaBodegaAClinica(sortOrder, buscar, pageNumber, 20);
        ...
        public async Task<IActionResult> Reporte(int? trasladoId)
        {
            ...
            return await _generatePdf.GetPdf("Views/TrasladosBodegaAClinica/Reporte.cshtml", model);
        }
        ...
        public async Task<IActionResult> ReporteU(int? trasladoId)
        {
            ...
            return await _generatePdf.GetPdf("Views/TrasladosBodegaAClinica/ReporteU.cshtml", model);
        }
